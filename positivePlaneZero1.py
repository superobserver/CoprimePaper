...
#the values generated by the 'relatively forgiving' filter for zeta candidates results with the positive halfplane zeta candidates matching well with the actual prime counting function. 
#I need to review how the signal is being generated
